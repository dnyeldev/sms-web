...
import { Tab, Nav, Row, Col, Button, Image, Badge } from "react-bootstrap";
...
import { getUserAvatarQuery } from "./gql";
...
export default function myProfile() {
  ...
  useEffect(() => {
    ...
    const countryCode = _.has(address, "countryCode")
      ? address.countryCode
      : null;
                    ...
                    <div className="card">
                      <div className="card-body">
                        ...
                        <div className="row">
                          ...
                          <p className="col-sm-10">{address}</p>
                        </div>
                        {/* <div className="row">
